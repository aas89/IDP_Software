...
bool sweep_towards_person() {
  ...
  while ((sweep_direction_count < 6) and (person_found == false)) {
    blinking();
    ...
    while (time_counter_a < sweep_start_timer + 30) {
      ...
      if (((previous_ultrasound-current_ultrasound) >= 10) and ((pre_prev_ultrasound-current_ultrasound) >= 10) and ((pre_x3_ultrasound-current_ultrasound) >= 10) and ((pre_x4_ultrasound-current_ultrasound) >= 10)) {
      ...
      pre_x3_ultrasound = pre_prev_ultrasound;
